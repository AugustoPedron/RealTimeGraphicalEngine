...
bool Bitmap::Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, long screenWidth, long screenHeight, const char* textureFilename, int renderX, int renderY)
{
  bool result;
